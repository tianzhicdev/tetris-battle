...
export const ABILITIES: Record<AbilityType, Ability> = {
  ...
  piece_preview_plus: {
    id: 'piece_preview_plus',
    type: 'piece_preview_plus',
    name: 'Piece Preview+',
    description: 'See next 5 pieces instead of 1',
    cost: 30 * COST_FACTOR,
    duration: 15000,
    cooldown: 20000,
    powerRating: 4,
  ...
  column_bomb: {
    ...
    type: 'column_bomb',
    name: 'Column Bomb',
    description: 'Drop 8 garbage blocks into a random column',
    cost: 45 * COST_FACTOR,
    cooldown: 15000,
    powerRating: 6,
    category: 'debuff',
  ...
  mirror_blocks: {
    ...
    type: 'mirror_blocks',
    name: 'Mirror Blocks',
    description: "Opponent's pieces are mirrored (flipped horizontally)",
    cost: 55 * COST_FACTOR,
    duration: 15000,
    cooldown: 20000,
    powerRating: 6,
  ...
  deflect_shield: {
    ...
    type: 'deflect_shield',
    name: 'Deflect Shield',
    description: 'Blocks next incoming debuff. Stays active until triggered',
    cost: 50 * COST_FACTOR,
    cooldown: 30000,
    powerRating: 6,
    category: 'defense',
  ...
  board_swap: {
    ...
    type: 'board_swap',
    name: 'Board Swap',
    description: 'You and opponent literally trade boards',
  ...
  gravity_invert: {
    ...
    type: 'gravity_invert',
    name: 'Gravity Invert',
    description: "Opponent's board flips upside down",
    cost: 120 * COST_FACTOR,
    duration: 10000,
    cooldown: 45000,
    powerRating: 10,
    category: 'ultra',
  ...
  mirror_match: {
    ...
    type: 'mirror_match',
    name: 'Mirror Match',
    description: "Every piece you place also drops on opponent's board",
    cost: 110 * COST_FACTOR,
    duration: 15000,
    cooldown: 45000,
    powerRating: 10,
    category: 'ultra',
