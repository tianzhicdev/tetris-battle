...
3. **Context getting long**: Update the work log with your exact current state — phase,
...
- **Be precise in the work log**: "Completed Step 7 of 12. Steps 1-7 implemented and
  tested. Next: Step 8 — modify PostMatchScreen.tsx for AI reward reduction."
- **The plan file is your instruction set on resume** — the next session will read
